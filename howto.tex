...
will detect the changes in the repository and recreate the Jenkins job.

\subsection{Autentication}

The access to \url{https://lsst-docs-ci.ncsa.illinois.edu/jenkins} is granted adding users to the docs-ci organization.

The required credentials to access Jira REST API and database are stored in \textit{1password.com}, LSST-IT architecture vault.
