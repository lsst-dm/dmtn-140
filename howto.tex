...
\item \texttt{file.tex} is the Test Plan and Report tex file where the document will be rendered, for example DMTR-231.tex};
\item \texttt{--trace true} (optional) generates an appending with the traceability information.
\end{itemize}

Each TM4J test plan and related informatino in Jira, is rendered in a different Test Plan and Report document.
