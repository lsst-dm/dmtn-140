...
This service is at the moment behind NCSA firewall, and therefore it requires VPN to access and monitor the jobs. However the otcome is available in the corresponding GitHub repositories and LSST The Docs landing pages.
...
Since the \textit{lsst-cocs-ci} service is behind a firewall, it the seeds job: 
