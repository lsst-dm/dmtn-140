...
to guarantee that survey software and infrastructure both fulfil the system requirements and enable the science that
...
tests and requirements. Test documents can therefore be generated programatically, avoiding typical problems
